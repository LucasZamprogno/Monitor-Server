...
function finalMetaAnalysisPass(analysis) {
	...
	data['commitAdditionPercentageByLines'] = Math.round(100 * data['additionLines'] / data['totalCodeLines'])/100;
	data['commitAdditionPercentageByLength'] = Math.round(100 * data['additionLength'] / data['totalLength'])/100;
	data['viewedAdditionPercentage'] = Math.round(100 * data['additionRaw'] / data['totalCodeTime'])/100;
	data['commitDeletionPercentageByLines'] = Math.round(100 * data['deletionLines'] / data['totalCodeLines'])/100;
	data['commitDeletionPercentageByLength'] = Math.round(100 * data['deletionLength'] / data['totalLength'])/100;
	data['viewedDeletionPercentage'] = Math.round(100 * data['deletionRaw'] / data['totalCodeTime'])/100;
	data['commitUnchangedPercentageByLines'] = Math.round(100 * data['unchangedLines'] / data['totalCodeLines'])/100;
	data['commitUnchangedPercentageByLength'] = Math.round(100 * data['unchangedLength'] / data['totalLength'])/100;
	data['viewedUnchangedPercentage'] = Math.round(100 * data['unchangedRaw'] / data['totalCodeTime'])/100;
	data['viewedExpandedPercentage'] = Math.round(100 * data['expandedRaw'] / data['totalCodeTime'])/100;
